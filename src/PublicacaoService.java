...
public class PublicacaoService {
    ...
    public List<Postagem> listarPostagens() {
        return postagens.values()
                .stream()
                .sorted(Comparator.comparing(Postagem::getMomentoCriado))
                .collect(Collectors.toList());
    }

    public boolean criaPostagem(Usuario usuario, String texto, List<String> tags) {
        Postagem postagem = new Postagem(usuario, texto, tags);
    ...
    public String top5PostagensComMaisComentarios(Usuario usuario) {
        if (usuario.getTipoUsuario() == Usuario.TipoUsuario.ADM) {
            Postagem postagem1 = new Postagem("Sem cadastro");
            Postagem postagem2 = new Postagem("Sem cadastro");
            Postagem postagem3 = new Postagem("Sem cadastro");
            Postagem postagem4 = new Postagem("Sem cadastro");
            Postagem postagem5 = new Postagem("Sem cadastro");
    ...
    public List<Postagem> buscaPostagemsPorTag(String tag) {
        return postagens
                .values().stream()
                .filter(postagem -> postagem.getTags().contains(tag))
                .sorted(Comparator.comparing(Postagem::getMomentoCriado))
                .collect(Collectors.toList());
    }
